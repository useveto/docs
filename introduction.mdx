...
Veto is a runtime authorization service for AI agents. It sits between your agent and the tools it calls, evaluates every action against the policies you define, and decides: **allow**, **deny**, or **escalate** — in under 10ms, at the edge.
